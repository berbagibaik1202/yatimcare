...
async function main() {
    ...
    const successfulByProgram = successfulDonations.reduce((acc, donation) => {
    ...
    const distributedByProgram = [...expenseItems, ...aidItems].reduce((acc, item) => {
        if (!item.programId) {
            return acc;
        }
    ...
    const aidByChild = aidItems.reduce((acc, item) => {
